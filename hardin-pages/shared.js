...
const ICON_PATHS = {
  // The Hardin seedling: two leaves, a stem and a little soil line
  seedling:
    '<path d="M12 21v-9"/>' +
  ...
  skipNext: '<path d="M6 5l10 7-10 7z" fill="currentColor"/><path d="M19 5v14"/>',
  skipPrev: '<path d="M18 5L8 12l10 7z" fill="currentColor"/><path d="M5 5v14"/>',
  volume:
    '<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5H4z"/><path d="M15.5 9a4 4 0 0 1 0 6M18 6.5a8 8 0 0 1 0 11"/>',
  calendar:
...
const EFFECT_TARGETS = [
  ".btn", ".icon-btn", ".react-btn", ".action-btn", ".tab", ".fmt",
  ".contact", ".cal-nav", ".cal-today", ".cal-day.has"
].join(",");
